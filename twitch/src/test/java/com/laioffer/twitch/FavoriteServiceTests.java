...
import com.laioffer.twitch.favorite.MyFavoriteService;
...
public class FavoriteServiceTests {
    ...
    private MyFavoriteService favoriteService;


    @BeforeEach
    public void setup() {
        favoriteService = new MyFavoriteService(itemRepository, favoriteRecordRepository);
    }
